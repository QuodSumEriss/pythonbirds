...
class Passaro(Ator):
    ...
    def calcular_posicao(self, tempo):
        ...
        :return: posição x, y
        """
        if self.esta_voando() and self.status == ATIVO:
            delta_t = tempo-self._tempo_de_lancamento
            self._calcular_posicaovertical(delta_t)
            self._calcular_posicaohorizontal(delta_t)
    ...
    def _calcular_posicaovertical(self, delta_t):
    ...
    def _calcular_posicaohorizontal(self, delta_t):
